...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    { path: "/bac-calculator-for-women", changeFreq: "weekly" as const, priority: 0.8 },
    { path: "/advanced-bac-calculator", changeFreq: "weekly" as const, priority: 0.8 },
    { path: "/bac-chart", changeFreq: "monthly" as const, priority: 0.7 },
