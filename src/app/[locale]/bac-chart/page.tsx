    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-5xl px-4 py-8 md:py-12">
          ...
          {/* Quick Win CTA */}
          <div className="mb-16 p-6 md:p-8 bg-blue-50 rounded-xl border border-blue-100 text-center shadow-sm">
            <h3 className="text-xl md:text-2xl font-bold text-blue-900 mb-2">
              Need a more precise estimate?
            </h3>
            <p className="text-blue-700 mb-6 text-lg max-w-2xl mx-auto">
              Charts are static approximations. Our calculator customizes the result for your exact weight, time, and drinks.
            </p>
            <a 
              href={`${locale === defaultLocale ? '' : `/${locale}`}/`}
              className="inline-flex items-center justify-center px-8 py-3 text-lg font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
            >
              Use the Calculator
