...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: getLanguageAlternates('/bac-calculator-dz'),
    },
    openGraph: {
      type: 'article',
      locale,
...
export default async function BacCalculatorDzPage({ params }: PageProps) {
  ...
  const docsMarkdown = `
## ${t('dz.legalSectionTitle')}

${t('dz.legalSectionBody')}

## ${t('dz.safetySectionTitle')}

${t('dz.safetySectionBody')}
`;

  const faqItems = [
    {
      question: t('dz.faq.q1'),
      answer: t('dz.faq.a1'),
    },
    {
      question: t('dz.faq.q2'),
      answer: t('dz.faq.a2'),
    },
    {
      question: t('dz.faq.q3'),
      answer: t('dz.faq.a3'),
    },
  ];
